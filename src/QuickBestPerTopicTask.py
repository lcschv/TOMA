...
for measure in ['AP','NDCG']:
    for track in ['2015','2016']:
        ...
        if measure == 'AP':
            folder = "data/results_weighting_cutoff_5_ap/TaskTrack"+str(track)+"/"
        else:
            folder = "data/results_weighting_cutoff_5/TaskTrack"+str(track)+"/"
        # instantiation = "AP"
        ...
        results_folder = "data/results_weighting/top_5_per_track_cutoff/TaskTrack"+str(track)+"/"
