...
for measure in ['AP','NDCG']:
    for track in [2015,2016]:
        # folder = "../data/results/TaskTrack2015/"
        # folder = "../data/results_cutoff100_ap/Decision/"
        # folder = "../data/results_cutoff100_ap/TaskTrack2016/"
        if measure == 'AP':
            folder = "data/results_weighting_cutoff100_ap/TaskTrack"+str(track)+"/"
        else:
            folder = "data/results_weighting_cutoff100/TaskTrack"+str(track) + "/"
        # instantiation = "AP"
        instantiation = measure
        # runs_folder = "../data/decisionRuns/"
        # runs_folder = "data/webtrack"+str(track)+"Runs_extracted/"
        runs_folder = "data/runs_track_newids/"+str(track) + "/"
        qrels_file = "data/qrels_tasktrack/qrels_"+str(track) +"_4aspects.txt"
        ...
        results_folder = "data/results_weighting/top_100_per_track_perquery_cutoff/Task"+str(track)+"/"
