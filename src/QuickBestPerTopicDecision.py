...
for measure in ['AP','NDCG']:
    for track in ['']:
        ...
        if measure == 'AP':
            folder = "data/results_weighting_cutoff_5_ap/Decision/"
        else:
            folder = "data/results_weighting_cutoff_5/Decision/"
        # instantiation = "AP"
        ...
        results_folder = "data/results_weighting/top_5_per_track_cutoff/Decision2019/"
