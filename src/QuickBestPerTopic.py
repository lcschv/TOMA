...
for measure in ['AP','NDCG']:
    for track in ['adhoc']:
        ...
        if measure == 'AP':
            folder = "data/results_weighting_cutoff_5_ap/Misinfo-"+str(track)+"/"
        else:
            folder = "data/results_weighting_cutoff_5/Misinfo-"+str(track)+"/"
        # instantiation = "AP"
        ...
        results_folder = "data/results_weighting/top_5_per_track_cutoff/Misinfo-"+track+'/'
